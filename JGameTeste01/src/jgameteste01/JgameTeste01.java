...
public class JgameTeste01 extends JGEngine {
	...
	public static void main(String [] args) {
		...
		new JgameTeste01(new JGPoint(640,480));
	}
	...
	public JgameTeste01(JGPoint size) {
	...
	public void initCanvas() {
		...
		setCanvasSettings(
			...
			JGColor.gray,// background colour -> use default colour black (eu mexi aq)
	...
	public void initGame() {
		...
		setFrameRate(
			35,// 35 = frame rate, 35 frames per second (eu mechi aq)
	...
	* paintFrame to do that. */
	...
	public void paintFrame() {
		setColor(JGColor.orange); // eu mexi aq
		...
		//       viewHeight the height.
                ...
                String msg = (xmouse == xpos) && (ymouse == ypos)?
                        "Show!!! Vc acertou.":
                        String.format("Acerte o ponto (x=%d, y=%d)", xmouse,ymouse);
		...
		drawString(msg,
			...
			0, // the text alignment
			  // (-1 is left-aligned, 0 is centered, 1 is right-aligned)
                        new JGFont("Sefif",1,15), //Font
                        (xmouse == xpos) && (ymouse == ypos)?JGColor.orange: JGColor.cyan //Color                           
		);
	}
}

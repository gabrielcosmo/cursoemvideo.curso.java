...
public class JgameTeste02 extends JGEngine {
	...
	public static void main(String [] args) {
		...
		new JgameTeste02(new JGPoint(640,480));             
	}
	...
	public JgameTeste02(JGPoint size) {
